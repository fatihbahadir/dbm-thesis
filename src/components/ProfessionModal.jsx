...
const ProfessionModal = ({
  ...
  const handleDelete = () => {
    axios
      .delete(`/api/v1/manager/profession/${profession.profession_id}`, {
        headers: {
  ...
  const handleUpdate = () => {
    ...
    axios
      .put(
        `/api/v1/manager/profession/${profession.profession_id}`,
        {
          profession_name: professionInput,
          profession_description: descriptionInput,
        },
        {
          headers: {
            Authorization: `Bearer ${auth.accessToken}`,
