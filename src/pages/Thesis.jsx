...
const Thesis = () => {
  ...
  return (
    <div>
      ...
      >
        {
          loading ? <div className="w-full min-h-[500px] md:min-h-[310px] flex h-full items-center justify-center">
            <LoadingSpinner/>
             </div>
             :
             <>
      ...
      >
        ...
        <div className="flex flex-col">
          {
            filterLoading ? <div className="min-h-[600px] w-full flex items-center justify-center">
              <LoadingSpinner/>
              </div>
              :
